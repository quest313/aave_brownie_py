...
def main():
    ...
    print(f"Amount we are going to borrow: {amount_dai_to_borrow}")
...
def get_asset_price(price_feed_address):
    ...
    print(f"The DAI / ETH prices is {converted_latest_price}")
...
def get_borrowable_data(lending_pool, account):
    ...
    total_colleral_eth = Web3.fromWei(total_colleral_eth, "ether")
    total_debt_eth = Web3.fromWei(total_debt_eth, "ether")
    print(f"You have {total_colleral_eth} worth of ETH deposited.")
